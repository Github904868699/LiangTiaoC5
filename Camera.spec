...
hiddenimports = ['ultralytics', 'torch', 'torchvision', 'torch.utils', 'torch.utils.data', 'torchvision.ops', 'cv2', 'numpy', 'PyQt5', 'PyQt5.QtCore', 'PyQt5.QtGui', 'PyQt5.QtWidgets', 'MvCameraControl_class', 'CameraParams_const', 'CameraParams_header', 'MvErrorDefine_const', 'PixelType_header']
